function [pos, vel, el, az, dop] = weightedLeastSquare(satpos, satvel, obs, dopp, settings)
%Function calculates the Least Square Solution.
%
%[pos, el, az, dop] = weightedleastSquare(satpos, obs, settings);
%
%   Inputs:
...
%--- Calculate velocity ---------------------------------------------------
c = zeros(nmbOfSatellites,1);
for index = 1: nmbOfSatellites
    c(index) = -dopp(index) - satvel(:, index)' * (A(index, 1:3))';
end
Wd = W .* W';
vel = (A'*Wd*A) \ (A'*Wd*c);
