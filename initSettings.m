...
settings.fileName           = "C:\Users\user\Documents\Homework\Opensky.bin";
% settings.fileName           = "C:\Users\user\Documents\Homework\Urban.dat";
...
settings.IF                 = 4.58e6;%1580e6-1575.42e6;     % [Hz]
% settings.IF                 = 0;
settings.samplingFreq       = 58e6;%4.092e6;%58e6;        % [Hz]
...
% Carrier Frequency
settings.carrFreq           = 1575.42e6;   % [Hz]
...
% True position in LLH
settings.truePosition.latitude  = 22.3198722;
settings.truePosition.longitude = 114.209101777778;
